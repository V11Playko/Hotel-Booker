...
public class UserRestController {
    ...
    public ResponseEntity<Map<String, String>> saveAdmin(@Valid @RequestBody UserModel user) {
    ...
    public ResponseEntity<Map<String, String>> saveOwner(@Valid @RequestBody UserModel user) {
        userService.saveUser(user);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Collections.singletonMap(Constants.RESPONSE_MESSAGE_KEY, Constants.USER_CREATED_MESSAGE));
    }
    ...
    public ResponseEntity<Map<String, String>> saveClient(@Valid @RequestBody UserModel user) {
        userService.saveUser(user);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(Collections.singletonMap(Constants.RESPONSE_MESSAGE_KEY, Constants.USER_CREATED_MESSAGE));
    }
